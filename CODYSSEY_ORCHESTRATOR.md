...
| 03 | [cloud-infra-aws](./cloud-infra-aws) | 🛡️ VPC 사설 격리 네트워크 기반 인프라 구축 | AWS, Cloud Infra | 🟢 Pending | - | d18a74a | N/A |
| 04 | [linux-system-monitor](./linux-system-monitor) | 🛡️ 시스템 관제 자동화 및 보안 구축 프로젝트 | C, Linux Sys, Shell | ❇️ Completed | 52b943ac-f000 | 6fad206 | Passed |
...
| 10 | [vanilla-js-portfolio](./vanilla-js-portfolio) | 🛡️ 단방향 상태 관리 기반 반응형 포트폴리오 | JS, HTML/CSS Web | 🟢 Pending | - | 3f12cf1 | Pending |
